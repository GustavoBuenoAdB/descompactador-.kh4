 ...
 *             int n_canais: n�mero de canais. Deve ser 1 ou 3. Se for 1,
...
/*----------------------------------------------------------------------------*/
/** Cria uma c�pia de uma imagem.
 *
 * Par�metros: Imagem* img: imagem a clonar.
 *
 * Valor de retorno: uma nova imagem, igual � imagem dada. */
 ...
 *
 * Par�metros: Imagem* in: copia desta imagem...
 ...
 * para o n�mero mais pr�ximo, truncando em 255.
 *
 * Par�metros: floax x: valor a converter.
 *
